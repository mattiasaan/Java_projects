...
/**
 * App principale della stampante base — menù di gestione.
 *
 * Presenta un menù con 6 opzioni: creare documento, stampare, accendere/
 * spegnere, mostrare coda, mostrare stampati, uscire. È il punto d'entrata
 * che coordina le classi Stampante e Documento.
 */
public class ProgStampante {
  public static void main(String args[]) throws IOException {
    ...
    // Legge l'opzione con validazione
    do {
      try {
    ...
    switch (opzione) {
      case 1: doc.inserisciDocumento(); break;
      case 2: stampante.stampaDocumento(); break;
      case 3: stampante.stato(); break;
      case 4: stampante.mostraCoda(); break;
      case 5: stampante.mostraStampati(); break;
