...
/**
 * Modello Stampante — rappresenta una stampante con tutti i suoi attributi.
 *
 * Contiene: identificativo, dati anagrafici (nome, marca, modello),
 * tipo di collegamento (cavo/rete con IP e subnet), livelli carta e
 * inchiostro per ogni colore, e la coda di stampa dei documenti in attesa.
 *
 * I getter e setter permettono a ProgStampante di leggere e aggiornare
 * lo stato senza accedere direttamente ai campi privati.
 */
public class Stampante {
  ...
  public Stampante(int ID, String nome, String marca, String modello,
      String stato, String collegamento, String ip, String subnet,
      byte carta, byte nero, byte magenta, byte ciano, byte giallo) {
    this.ID = ID;
    this.nome = nome;
    this.marca = marca;
